...
function preload(){
    ...
    handGunkitWeaponImage = loadAnimation("Top_Down_Survivor/handgun/meleeattack/survivor-meleeattack_handgun_0.png");

    gunKitWeaponImage = loadAnimation("Top_Down_Survivor/rifle/move/survivor-move_rifle_3.png");

    shotGunWeaponImage = loadAnimation("Top_Down_Survivor/shotgun/move/survivor-move_shotgun_1.png");
